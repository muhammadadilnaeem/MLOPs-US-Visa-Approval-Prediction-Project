...
# Since I do not have an aws account so i will implement it by using locally by loading model from my system
...
import pickle  # Add import for loading the model

# Import project-specific modules and constants
from us_visa_project.constants import APP_HOST, APP_PORT
from us_visa_project.pipline.prediction_pipeline import USvisaData
from us_visa_project.pipline.training_pipeline import TrainPipeline
...
# Define the classifier class to load and use the prediction model
...
async def index(request: Request):
    ...
    return templates.TemplateResponse(
        "index2.html", {"request": request, "context": "Rendering"}
    )
...
async def predictRouteClient(request: Request):
    ...
    try:
        ...
        model_path = r"E:\MLOPs-US-Visa-Approval-Prediction-Project\artifact\11_03_2024_12_04_52\model_trainer\trained_model\model.pkl"

        # Instantiate the model classifier and perform prediction
        model_predictor = USvisaClassifier(model_path=model_path)
